...
def Tohdf5(matImgA, matImgB, matdiffAB, id, jth):
    ...
    trainImg = np.zeros([1, 3, d1, d2, d3], dtype=np.float32)
    trainImg_A = np.zeros([1, 1, d1, d2, d3], dtype=np.float32)
    trainImg_B = np.zeros([1, 1, d1, d2, d3], dtype=np.float32)
    ...
    trainImg_A[0, 0, :, :, :]= matImgA
    trainImg_B[0, 0, :, :, :]= matImgB
